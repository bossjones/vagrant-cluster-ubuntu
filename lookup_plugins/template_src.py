...
# SOURCE: https://github.com/pascalandy/tutorial-do/blob/master/ansible/lookup_plugins/template_src.py
                    ...
                    for term in terms:
                        if '_original_file' in inject:
                            relative_path = utils.path_dwim_relative(
                                inject['_original_file'], 'templates', '', self.basedir, check=False)
